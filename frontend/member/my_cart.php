              ...
              <tbody>
	                ...
	                <tr data-toggle="collapse" data-target="#demo1" class="accordion-toggle">
	                  ...
	                  <td data-title="更新">
										...
										<td data-title="刪除">
											<a class="btn btn-default" href="cart_delete.php?CartID=<?php echo $i; ?>" onclick="if(!confirm('是否從購物車移除此商品？')){return false;};" ><i class="fa fa-times"></i></a>
										</td>
	                </tr>
