	          ...
	          <div class="col-md-12">
					<form action="apply_success.php" method="post" data-toggle="validator">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="password" class="form-control" id="password" name="password" pattern="^(?!.*[^a-zA-Z0-9])(?=.*\d)(?=.*[a-zA-Z]).{6,12}$" data-minlength="6" required data-error="請輸入至少6個英文數字做為密碼(至少含1個數字)">
								<div class="help-block with-errors"></div>
							</div>
						</div>
						<div class="form-group">
